...
1. In the **first response that needs any tool call**, use the structured synchronization **before** beginning action (**this is very important**). A response that needs no tool call may output its conclusion directly.
